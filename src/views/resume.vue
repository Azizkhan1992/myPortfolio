        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="resume-item pb-0 resumeWr">
              ...
              <p><em>У меня есть один год опыта работы с FrontEnd веб-программированием с нуля до конца, работая с Figma. В настоящее время я изучаю BackEnd веб-программирование PHP Laravel MySQL</em></p>
              <p>
              <ul>
                <li>
...
.resume-item{
    border-left: 2px solid #0563bb !important;
